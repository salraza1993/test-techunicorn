...
function ProductDetails({ increaseQuantity, decreaseQuantity, addToCart }) {
  const { id } = useParams();
  ...
  const titleCase = (str) => {
    String(str).split(' ').map((letter) => letter[0].toUpperCase() + letter.slice(1)).join(' ')
  }
  return (
    <>
                ...
                <div className="product__details__content">
                  ...
                  <ul className='product__info mb-3'>
                    ...
                    <li>
                      <span>Category</span>
                      <span>: {
                        String(product?.category).split(' ').map((letter) => letter[0].toUpperCase() + letter.slice(1)).join(' ')
                      }</span>
                    </li>
                    <li>
                      <span>Tags</span>
                  ...
                  <div className="d-flex align-items-center gap-3">
                    <button className="btn btn-primary btn-lg d-flex align-items-center gap-3 px-5" onClick={() => addToCart(product?.id)}>
                      Add To Cart
                      <svg className="pe-none" width="25" height="20" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
